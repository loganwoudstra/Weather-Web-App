# Weather-Web-App
A weather web app which allows users to access the current weather, weather forecast for the next 24 hours, weather forecast for the next week, and weather warning for any city around the world
